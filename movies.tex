...
% It consists of two parts. The first part has 9800 video clips of length between 8 to 12 seconds taken from 160 movies. Each video has a single global valence and arousal rating in the range 1 to 5, annotated by 1517 annotators from 89 different countries using crowdsourcing. 
...
%	\centering
%	\caption{Performance of different models, knowledge transfer and gradient boosting on valence and arousal prediction}
%	\label{fig:performance}
%\end{figure}

%\begin{figure}[h]
%	\includegraphics[width=18cm]{comparison.jpg}
%	\centering
%	\caption{Performance of Baseline and Boosting across movies}
%	\label{comparison}
%\end{figure}
